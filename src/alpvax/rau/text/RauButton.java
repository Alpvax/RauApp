...
public class RauButton extends Button implements IRauText
{
	private CharSequence rauText;
	private CharSequence latText;
	private EnumLanguage currentLang;

	public RauButton(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		...
		try
		{
	    	...
	    	setCurrentLang(EnumLanguage.get(a.getInt(R.styleable.RauButton_language, /*TODO: get from settings*/0)));
		}
		finally
		{
			a.recycle();
